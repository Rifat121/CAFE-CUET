...
if(!empty($_POST))
	{
		...
		$sql = "UPDATE `tbl_product` SET `price`='$price' WHERE name='$name'";
...
<body>
	...
	<div class="creg">
		...
		<label>Price : </label><input type="text" name="price" placeholder="Enter updated price" required><br><br>

		</p>
		<input type="submit" class="regg" name="submit" value="UPDATE"><br><br>
